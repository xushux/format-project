...
![fix_type_issue](./images/fix_type_issue.png)
...
![fix_close_issue.png](./images/fix_close_issue.png)

该提交会关闭 #2 issue，注意 issue 详情里会自动关联 commit 信息中有 #issue 编号的提交，如下图，

![fix_close_issue_2.png](./images/fix_close_issue_2.png)
